        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Revolutionizing laundry care with our innovative compartmentalized
              technology. 99% cleaning efficiency, long-lasting fragrance, and
              complete color protection.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/profile.php?id=61577355719076"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-brand-blue transition-colors duration-300 group"
              ...
              <a
                href="https://www.instagram.com/welvetwash/"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-pink-500 transition-colors duration-300 group"
              ...
              <a
                href="https://www.linkedin.com/company/welvet-wash/"
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
                  className="text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-300"
                  data-testid="footer-link-5in1-pods"
                >
                  5-in-1 Laundry Pods
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-300"
                  data-testid="footer-link-bulk-orders"
                >
                  Bulk Orders
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-300"
                  data-testid="footer-link-wholesale"
                >
                  Wholesale Program
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-300"
                  data-testid="footer-link-samples"
                >
                  Free Samples
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="text-gray-300 hover:text-white hover:translate-x-1 transition-all duration-300"
                  data-testid="footer-link-custom"
                >
                  Custom Solutions
                </a>
              </li>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div
                ...
                data-testid="contact-phone-footer"
              >
              ...
              <div
                className="flex items-center space-x-3"
                data-testid="contact-email-footer"
              >
