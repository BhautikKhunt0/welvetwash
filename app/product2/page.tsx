      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-6">
            5-in-1 Deep Clean Best Seller
          </h1>
          <p className="text-xl text-cyan-100 max-w-3xl mx-auto mb-8">
            Let's Work on Your Next Clothes & Personal Care Project - 5 in 1
            Deep Clean Best seller Fragrance flowers OEM package Liquid Capsule
          </p>
          <div className="inline-block bg-white/20 px-6 py-3 rounded-full backdrop-blur-md">
            <span className="text-lg font-semibold">
              North Island Premium Quality
            </span>
          </div>
        </div>
      </section>
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">
                      1. Advanced Encapsulation Technology: Premium Scent
                      Release
                    </h4>
                    <p className="text-gray-600">
                      Our enhanced microcapsule technology delivers luxury
                      fragrance that activates during movement, providing
                      premium scent experience throughout the day.
                    </p>
                  </div>

                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">
                      2. 85%-90% Ultra-High Concentration: Premium Cleaning
                      Power
                    </h4>
                    <p className="text-gray-600">
                      Maximum concentration of active ingredients ensures
                      superior cleaning performance, making it the premium
                      choice for immaculate results.
                    </p>
                  </div>

                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">
                      3. Advanced Antimicrobial Protection: 99.9% Elimination
                      Rate
                    </h4>
                    <p className="text-gray-600">
                      Our premium formula provides comprehensive protection
                      against bacteria, viruses, and allergens for ultimate
                      hygiene and safety.
                    </p>
                  </div>
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">
                      4. Luxury Fragrance Collection: Premium Scent Experience
                    </h4>
                    <p className="text-gray-600">
                      Featuring premium international fragrance blends,
                      delivering sophisticated and long-lasting luxury aroma
                      experience.
                    </p>
                  </div>
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-2">
                      5. Premium Sustainability: Eco-Luxury Balance
                    </h4>
                    <p className="text-gray-600">
                      Advanced biodegradable formula with premium natural
                      ingredients, protecting both fabrics and environment with
                      luxury care.
                    </p>
                  </div>
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-cyan-50 p-8 rounded-2xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Friction-Activated Fragrance: Microcapsule Magic
              </h3>
              <p className="text-gray-600">
                Our microcapsule tech lets fragrance seep into the fabric during
                wear or exercise, releasing a continuous, pleasant scent.
              </p>
            </div>
            ...
            <div className="bg-rose-50 p-8 rounded-2xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                70%-80% High-Concentration: Laundry's Powerhouse
              </h3>
              <p className="text-gray-600">
                Loaded with active ingredients, it ensures clothes come out
                spotless, a reliable choice for clean laundry.
              </p>
            </div>
            ...
            <div className="bg-purple-50 p-8 rounded-2xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Banish Bacteria and Mites: Hidden Threats No More
              </h3>
              <p className="text-gray-600">
                Our product combats unseen bacteria and mites, promising a
                hygienic, comfortable clothing experience.
              </p>
            </div>
            ...
            <div className="bg-green-50 p-8 rounded-2xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Renowned Brand Givaudan Scents: Long-Lasting Elegance
              </h3>
              <p className="text-gray-600">
                Featuring high-end fragrances, clothes carry a sophisticated,
                lingering aroma.
              </p>
            </div>
            ...
            <div className="bg-orange-50 p-8 rounded-2xl">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">
                Pledge: Sustainable by Design
              </h3>
              <p className="text-gray-600">
                Using natural fragrances and biodegradable film, we safeguard
                the planet from production.
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-600">
                Low-foam formula rinses out effortlessly, leaving no soapy
                residue, saving time and water during rinse cycle.
              </p>
            </div>
            ...
            <div className="bg-emerald-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-600">
                Imported water-soluble film dissolves rapidly with zero residue,
                reducing waste and aligning with sustainable practices.
              </p>
            </div>
            ...
            <div className="bg-indigo-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-600">
                Built to withstand pressure up to 600N, these laundry pods are
                resistant to compression, maintaining quality during storage.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              5-in-1 Deep Clean Best Seller - Authentic Laundry Detergent Pods
            </p>
          </div>
              ...
              <table className="w-full min-w-[1000px]">
                <thead>
                  <tr className="bg-gradient-to-r from-cyan-50 to-blue-50 border-b border-gray-200">
                    <th className="px-4 sm:px-6 lg:px-8 py-4 text-left text-sm sm:text-base lg:text-lg font-semibold text-gray-900 whitespace-nowrap">
                      Specification
                    </th>
                    <th className="px-4 sm:px-6 lg:px-8 py-4 text-left text-sm sm:text-base lg:text-lg font-semibold text-gray-900">
                      Details
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  <tr className="hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <td className="px-4 sm:px-6 lg:px-8 py-4 text-gray-600 text-sm sm:text-base">
                      Authentic Laundry Detergent Pods
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors duration-200">
                    <td className="px-4 sm:px-6 lg:px-8 py-4 font-semibold text-gray-900 text-sm sm:text-base whitespace-nowrap">
                    ...
                    <td className="px-4 sm:px-6 lg:px-8 py-4 text-gray-600 text-sm sm:text-base leading-relaxed">
                      Detergent + Bacteria & Mites Removal 99.9% + Softener +
                      Long Lasting Fragrances + Blend Enzymes
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors duration-200">
                    <td className="px-4 sm:px-6 lg:px-8 py-4 font-semibold text-gray-900 text-sm sm:text-base whitespace-nowrap">
                    ...
                    <td className="px-4 sm:px-6 lg:px-8 py-4 text-gray-600 text-sm sm:text-base">
                      As shown in the picture or Customized
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors duration-200">
                    <td className="px-4 sm:px-6 lg:px-8 py-4 font-semibold text-gray-900 text-sm sm:text-base whitespace-nowrap">
                    ...
                    <td className="px-4 sm:px-6 lg:px-8 py-4 text-gray-600 text-sm sm:text-base">
                      As shown in the picture / Customized
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors duration-200">
                    <td className="px-4 sm:px-6 lg:px-8 py-4 font-semibold text-gray-900 text-sm sm:text-base whitespace-nowrap">
                  ...
                  <tr className="hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <td className="px-4 sm:px-6 lg:px-8 py-4 text-gray-600 text-sm sm:text-base">
                      Boxes/Bags or Pouches/Cartons or customized
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors duration-200">
                    <td className="px-4 sm:px-6 lg:px-8 py-4 font-semibold text-gray-900 text-sm sm:text-base whitespace-nowrap">
                  ...
                  <tr className="hover:bg-gray-50 transition-colors duration-200">
                    <td className="px-4 sm:px-6 lg:px-8 py-4 font-semibold text-gray-900 text-sm sm:text-base border-b-0 whitespace-nowrap">
                      Order (MOQ)
                    </td>
                    <td className="px-4 sm:px-6 lg:px-8 py-4 text-gray-600 text-sm sm:text-base border-b-0">
                      One Cartons of spot goods/customized
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div className="grid md:grid-cols-4 gap-8 mt-16">
            <div className="text-center bg-white p-8 rounded-2xl shadow-lg">
              <div
                ...
                data-testid="text-concentration"
              >
                70%-80%
              </div>
            ...
            <div className="text-center bg-white p-8 rounded-2xl shadow-lg">
              <div
                ...
                data-testid="text-bacteria-removal"
              >
                99.9%
              </div>
              <div className="text-gray-600 font-medium">
                Bacteria & Mites Removal
              </div>
            </div>
            <div className="text-center bg-white p-8 rounded-2xl shadow-lg">
              <div
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-12">
            Premium Usage Instructions
          </h2>

          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">
                Premium Dosage Guidelines
              </h3>
              <div className="space-y-4">
                <div
                  className="bg-blue-50 p-6 rounded-xl shadow-sm"
                  data-testid="dosage-standard"
                >
                  <div className="flex items-center space-x-4 mb-3">
                    ...
                    <h4 className="font-semibold text-gray-900">
                      Premium Standard Load
                    </h4>
                  </div>
                  <p className="text-gray-600 ml-14">
                    Use 1 premium pod (20g) for 10-15 pieces of clothing
                  </p>
                </div>
                <div
                  className="bg-green-50 p-6 rounded-xl shadow-sm"
                  data-testid="dosage-heavy"
                >
                  <div className="flex items-center space-x-4 mb-3">
                  ...
                  <p className="text-gray-600 ml-14">
                    Adjust premium dosage for heavily soiled items and larger
                    loads
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Use premium wash cycles for optimal results, minimum 20
                ...
                <div
                  className="bg-blue-50 border-l-4 border-blue-400 p-6 rounded-r-xl"
                  data-testid="note-storage"
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Store in premium conditions with moisture control and
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-cyan-100 mb-8">
            Elevate your laundry routine with our revolutionary 7-in-1 premium
            formula. Professional luxury cleaning power in every premium pod.
          </p>
