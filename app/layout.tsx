...
export const metadata: Metadata = {
  ...
  description:
    "WelvetWash offers revolutionary 5-in-1 and 7-in-1 laundry pod technology with advanced cleaning power, anti-bacterial protection, and eco-friendly design.",
  keywords:
    "laundry pods, detergent, cleaning, eco-friendly, anti-bacterial, premium quality",
};
  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className="font-sans antialiased bg-background text-foreground">
        ...
        <a
          href="https://wa.me/919974398064?text=Hi! I'm interested in WelvetWash laundry pods. Can you help me with more information?"
          target="_blank"
